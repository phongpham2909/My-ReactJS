...
class SectionAdd extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps && nextProps.categoryEditing) {
            ...
            this.setState({
                id: categoryEditing.categoryID,
                name: categoryEditing.categoryName,
                description: categoryEditing.categoryDescription,
                image: categoryEditing.categoryImage
            })
        }
    }
    handleChange = (event) => {
    ...
    handleSave = (event) => {
        ...
        const { history, actUpdateCategory, actAddCategory } = this.props;
        const category = {
            categoryID: id,
            categoryName: name,
